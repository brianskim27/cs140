...
public class kim_lab7 {
	public static void main(String[] args) {
		...
		VertexWithWeight[] a1 = p.toArray(new VertexWithWeight[0]);
		for(VertexWithWeight v : a1)
        ...
        VertexWithWeight[] a2 = p.toArray(new VertexWithWeight[0]);
        for(VertexWithWeight v : a2)
            System.out.println(v);
