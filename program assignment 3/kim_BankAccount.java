class kim_BankAccount {
	...
	kim_BankAccount(String ownerLastName, String ownerFirstName, double checkingBalance, double savingsBalance) {
	...
	kim_BankAccount(String ownerLastName, String ownerFirstName) {
